    ...
    <main className="min-h-screen bg-[#F8FAFC] pb-28 text-[#0F172A]">
      ...
      <section className="mx-auto max-w-6xl px-5 py-7 md:py-9">
        <div className="mb-6">
          ...
          <h1 className="mt-1 text-4xl font-black tracking-tight text-[#0F172A]">Today&apos;s Care</h1>
          <p className="mt-3 max-w-2xl text-base leading-7 text-[#64748B]">
            Track today&apos;s care from scheduled sessions.
          </p>
        </div>
        ...
        <section className="rounded-[36px] border border-blue-100 bg-white p-6 shadow-xl shadow-blue-100/45">
          <div className="flex flex-wrap items-center justify-between gap-3">
            <div>
              ...
              <h2 className="mt-1 text-3xl font-black text-[#0F172A]">Today&apos;s Care</h2>
            </div>
          ...
          {sessions.length === 0 ? (
            <div className="mt-7 rounded-[28px] border border-dashed border-blue-200 bg-blue-50/40 p-10 text-center">
              ...
              <p className="mt-4 font-semibold text-[#0F172A]">No care sessions today</p>
            ...
            <div className="mt-7 space-y-4">
              {sessions.map((session) => {
                ...
                const totalCareActions = plannedActions.length + sessionEvents.filter((event) => event.source === "added").length;
